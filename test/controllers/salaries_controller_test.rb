...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { name: @salary.name, salary_annual: @salary.salary_annual, salary_hourly: @salary.salary_hourly } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { name: @salary.name, salary_annual: @salary.salary_annual, salary_hourly: @salary.salary_hourly } }
